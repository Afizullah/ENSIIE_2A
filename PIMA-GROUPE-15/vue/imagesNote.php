...
<head>
    ...
    <title>Images que vous avez noté</title>
    <script type="text/javascript" src="../commun/services.js"></script>
</head>

<body>
<header>
    <h1>Images que vous avez noté</h1>
</header>
...
<script>
    ...
    let imagesToLoad = <?php echo json_encode(gradedImage($page, $user)); ?>;

    let promises = [];

    for (let i = 0; i < imagesToLoad.length; i++) {
        promises.push(serviceNasa.getPictureByDate(imagesToLoad[i].picture_date));
    }
